...
cp "${BR2_EXTERNAL_TECHNOLOGIC_PATH}"/board/tsimx6ul-usbprod/scripts/blast_funcs.sh "${TEMPDIR}/"
cp "${BR2_EXTERNAL_TECHNOLOGIC_PATH}"/board/tsimx6ul-usbprod/scripts/sanitize_linux_rootfs.sh "${TEMPDIR}/"
