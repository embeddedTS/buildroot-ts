...
tar cjf "${BINARIES_DIR}"/tsimx6ul-usb-image-replicator-rootfs.tar.bz2 -C "${TEMPDIR}" .
...
genimage \
  ...
  --config ""${BR2_EXTERNAL_TECHNOLOGIC_PATH}"/board/tsimx6ul-usbprod/scripts/genimage.cfg"
