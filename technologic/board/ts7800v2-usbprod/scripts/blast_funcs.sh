...
untar_image() {
	...
	(
		...
		# XXX: The original ts7800v2 blast.sh script used the modified
		# ext4 command with some options turned off. I don't think this
		# is necessary here.
		mkfs.ext4 "${DST_DEV_PART}"1 -q -F || err_exit "mke2fs ${DST_DEV}"
