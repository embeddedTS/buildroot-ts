...
cp "${BR2_EXTERNAL_TECHNOLOGIC_PATH}"/board/tsimx6-usbprod/scripts/blast_funcs.sh "${TEMPDIR}/"
cp "${BR2_EXTERNAL_TECHNOLOGIC_PATH}"/board/tsimx6-usbprod/scripts/sanitize_linux_rootfs.sh "${TEMPDIR}/"
